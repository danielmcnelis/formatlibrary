...
;(async () => {
	try {
		console.log(`Started refreshing ${formatLibraryCommandNames.length} Format Library guild (/) commands.`)
		...
		console.log(`Successfully reloaded ${formatLibraryCommandNames.length} Format Library guild (/) commands.`)

		console.log(`Started refreshing ${globalCommandNames.length} global application (/) commands.`)
