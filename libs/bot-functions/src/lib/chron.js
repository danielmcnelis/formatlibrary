    ...
    for (let i = 0; i < formats.length; i++) {
        ...
        for (let i = 0; i < allMatches.length; i++) {
            try {
                ...
                const winnerKFactor = winnerStats.games < 20 && winnerStats.bestElo < 580 ? 24 :
                    winnerStats.bestElo < 580 ? 16 : 8

                const loserKFactor = loserStats.games < 20 && loserStats.bestElo < 580 ? 24 :
                    loserStats.bestElo < 580 ? 16 : 8
