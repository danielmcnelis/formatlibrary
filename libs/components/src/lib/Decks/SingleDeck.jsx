...
const emojis = {
  ...
  Palette: 'https://cdn.formatlibrary.com/images/emojis/palette.png',
...
const { Palette, Bolt, Bow, Volcano, Helmet, Controller, Orb, Lock, Thinking, First, Second, Third, Consolation, Heart, Disk, Eye } = emojis
