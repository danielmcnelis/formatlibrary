            ...
            <div className="player-profile-flexbox">
                ...
                <div className="player-profile-title">{player.name}</div>
                    ...
                    <div className="profile-info"> 
                        ...
                        {
                            player.country ? (
                                <div className="profile-line"><b>Country:</b> {regionNames.of(player.country)} <img className="country" src={`https://www.worldometers.info/img/flags/${(iso2ToFips[player.country] || player.country).toLowerCase()}-flag.gif`} alt={player.country + ' flag'}/></div>
                            ) : ''
                        }
                        {
                            player.timeZone ? (
