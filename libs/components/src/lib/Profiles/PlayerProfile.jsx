        ...
        <div className="player-info">
          <div className="player-profile-title">{player.name}</div>
            ...
            <div className="profile-info"> 
                ...
                <div className="profile-line"><b>Discord:</b> {player.globalName || player.displayName || player.discordName && player.discriminator && player.discriminator 
!== '0' ? (<><span>{player.discordName}</span><span style={{ color: 'gray' }}>#{player.discriminator}</span></>) : player.discordName || 'N/A'}</div>
                {
                    player.country ? (
