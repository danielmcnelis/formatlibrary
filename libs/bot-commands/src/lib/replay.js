...
export default {
    ...
    async execute(interaction) {
        ...
        const challongeMatch = await axios.get(`https://api.challonge.com/v1/tournaments/{tournament}/matches/${match.id}.json?api_key=${server.challongeAPIKey}`).catch((err) => console.log(err))
