...
import { checkDeckList, checkOPDeckList } from '@fl/bot-functions'
...
export default {
    ...
    async execute(interaction) {
        ...
        if (format.category !== 'TCG' && format.category !== 'OP') return await interaction.reply(`Sorry, ${format.category} formats are not supported at this time.`)
