...
import { Card, Membership, Player, Print, Role, Set, Stats, Status, Tournament } from '.././db/index.js'
import * as emojis from '../emojis/emojis'
import rarities from '../emojis/rarities'
...
//IS MOD?
export const isMod = (server, member) => (server && member && member._roles.includes(server.modRole || server.adminRole)) || member.user.id === '194147938786738176'
